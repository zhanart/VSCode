...
class SessionTreeDataProvider {
    constructor(liveShare, callingService) {
        ...
        */
        ...
        this.callingService.onParticipantsChanged(() => this.changeEventEmitter.fire(this.updateParticipantsListItem()));
        ...
        return __awaiter(this, void 0, void 0, function* () {
            switch (this.sessionState) {
                ...
                case session_1.SessionState.LiveShareWithAudio:
                    const participantCount = 1 + (yield this.callingService.getCurrentParticipants()).length;
